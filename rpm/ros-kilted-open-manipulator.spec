...
Name:           ros-kilted-open-manipulator
Version:        4.1.2
...
Requires:       ros-kilted-om-gravity-compensation-controller
Requires:       ros-kilted-om-joint-trajectory-command-broadcaster
Requires:       ros-kilted-om-spring-actuator-controller
Requires:       ros-kilted-open-manipulator-bringup
Requires:       ros-kilted-open-manipulator-collision
Requires:       ros-kilted-open-manipulator-description
Requires:       ros-kilted-open-manipulator-gui
Requires:       ros-kilted-open-manipulator-moveit-config
Requires:       ros-kilted-open-manipulator-playground
Requires:       ros-kilted-open-manipulator-teleop
