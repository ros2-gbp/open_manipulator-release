...
%global pkg_name open_manipulator_collision
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-open-manipulator-collision
Version:        4.1.2
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Pyo <pyo@robotis.com> - 4.1.2-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Pyo <pyo@robotis.com> - 4.1.2-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Pyo <pyo@robotis.com> - 4.1.2-1
- Autogenerated by Bloom
